 ...
 */
public class IPhoneDroneConfiguration implements DroneConfiguration<IPhoneDroneConfiguration> {
    ...
    public IPhoneDroneConfiguration configure(ArquillianDescriptor descriptor, Class<? extends Annotation> qualifier) {
